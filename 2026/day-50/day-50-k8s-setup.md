...
👉 Borg was used to manage containers at massive scale inside Google.
...
Greek word → “Helmsman” (ship pilot) 🚢
Symbol → steering wheel (you’ll see 7 spokes = k8s)
...
![Images](images/kubernetes%20Architecture%20.png)
